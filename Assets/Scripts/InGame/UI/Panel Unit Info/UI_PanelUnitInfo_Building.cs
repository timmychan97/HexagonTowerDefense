...
public class UI_PanelUnitInfo_Building : UI_PanelUnitInfo
{
    ...
    public override void UpdateInfo()
    {
        ...
        SetInfo(building.GetName(), building.level, building.GetHp(), building.GetMaxHp(), building.description, building.cost);
    }

    public void SetUnit(Building b) => building = b;
    void SetInfo(string _name, int _level, float _hp, float _maxHp, string _description, int _cost) 
    {
